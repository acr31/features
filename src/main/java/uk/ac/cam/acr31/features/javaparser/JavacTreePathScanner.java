...
public class JavacTreePathScanner extends TreePathScanner<Void, TreeNode> {
  ...
  public Void visitCompilationUnit(CompilationUnitTree node, TreeNode treeNode) {
    TreeNode result = new TreeNode(node.getKind().name());
    treeNode.children.add(result);
  ...
  public Void visitImport(ImportTree node, TreeNode treeNode) {
    TreeNode result =
        new TreeNode(node.getKind().name(), node.isStatic() ? "static_import" : "import");
    treeNode.children.add(result);
  ...
  public Void visitClass(ClassTree node, TreeNode treeNode) {
    TreeNode result = new TreeNode(node.getKind().name(), String.valueOf(node.getSimpleName()));
    treeNode.children.add(result);
  ...
  public Void visitMethod(MethodTree node, TreeNode treeNode) {
    TreeNode result = new TreeNode(node.getKind().name(), String.valueOf(node.getName()));
    treeNode.children.add(result);
  ...
  public Void visitBlock(BlockTree node, TreeNode treeNode) {
    TreeNode result =
        new TreeNode(node.getKind().name(), node.isStatic() ? "static_block" : "block");
    treeNode.children.add(result);
  ...
  public Void visitLabeledStatement(LabeledStatementTree node, TreeNode treeNode) {
    TreeNode result = new TreeNode(node.getKind().name(), String.valueOf(node.getLabel()));
    treeNode.children.add(result);
  ...
  public Void visitLambdaExpression(LambdaExpressionTree node, TreeNode treeNode) {
    TreeNode result = new TreeNode(node.getKind().name(), node.getBodyKind().name());
    treeNode.children.add(result);
  ...
  public Void visitMemberSelect(MemberSelectTree node, TreeNode treeNode) {
    TreeNode result = new TreeNode(node.getKind().name(), String.valueOf(node.getIdentifier()));
    treeNode.children.add(result);
  ...
  public Void visitMemberReference(MemberReferenceTree node, TreeNode treeNode) {
    TreeNode result =
        new TreeNode(
            node.getKind().name(), String.valueOf(node.getMode()), String.valueOf(node.getName()));
    treeNode.children.add(result);
  ...
  public Void visitIdentifier(IdentifierTree node, TreeNode treeNode) {
    ...
    TreeNode result = new TreeNode(node.getKind().name(), name);
    treeNode.children.add(result);
  ...
  public Void visitLiteral(LiteralTree node, TreeNode treeNode) {
    ...
    TreeNode result = new TreeNode(node.getKind().name(), "\"" + literalValue + "\"");
    treeNode.children.add(result);
  ...
  public Void visitPrimitiveType(PrimitiveTypeTree node, TreeNode treeNode) {
    TreeNode result =
        new TreeNode(node.getKind().name(), String.valueOf(node.getPrimitiveTypeKind()));
    treeNode.children.add(result);
  ...
  public Void visitModifiers(ModifiersTree node, TreeNode treeNode) {
    ...
    node.getFlags().forEach(f -> flags.children.add(new TreeNode(String.valueOf(f))));
  ...
  public Void visitModule(ModuleTree node, TreeNode treeNode) {
    TreeNode result = new TreeNode(node.getKind().name(), String.valueOf(node.getModuleType()));
    treeNode.children.add(result);
